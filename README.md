...
2. In tunnel mode, the SDK works with the host VPN service to intercept packets from the TUN device and redirect traffic to Lantern based on a set of routing rules.
